...
#pragma warning disable S1854 // Unused assignments should be removed
    private IEnumerable<OperationClaim> getFeatureOperationClaims(int initialId)
    {
        ...
        #region FuelTrues CRUD
        featureOperationClaims.AddRange(
            [
                new() { Id = ++lastId, Name = FuelTruesOperationClaims.Admin },
                new() { Id = ++lastId, Name = FuelTruesOperationClaims.Read },
                new() { Id = ++lastId, Name = FuelTruesOperationClaims.Write },
                new() { Id = ++lastId, Name = FuelTruesOperationClaims.Create },
                new() { Id = ++lastId, Name = FuelTruesOperationClaims.Update },
                new() { Id = ++lastId, Name = FuelTruesOperationClaims.Delete },
            ]
        );
        #endregion
